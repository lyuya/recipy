                ...
                <div className="h-full">
                    <section className="h-full flex justify-center">
                        <div className="p-6 w-4/5 overflow-auto leading-5 bg-white/50">
                            ...
                            {!(loading || recipe.length > 0) && (<div>Tell me what ingredients do you want to cook, what kind of dish do you prefer, which ingredient do you want to avoid, etc.</div>)}
                        </div>
                    </section>
                </div>
            </div>
            <SearchBar onSearchInText={async (keywords) => await fetchRecipeInText(keywords)}></SearchBar>
        </>
    )
}